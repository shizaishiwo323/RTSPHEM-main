...
if isfield(options, 'initialPrecipitatedState') && ...
        ~isempty(options.initialPrecipitatedState)
    precipitatedState = options.initialPrecipitatedState;
else
    ...
    precipitatedState = precipitationRun.state;
end
