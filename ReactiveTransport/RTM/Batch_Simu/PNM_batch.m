...
cfg.timeStepperType = getParam(params, 'timeStepperType', 'expmax');
...
cfg.adaptiveMaxTimeStep = getParam(params, 'adaptiveMaxTimeStep', []);
...
cfg.circleRadius = getParam(params, 'circleRadius', []);
cfg.circleSpacing = getParam(params, 'circleSpacing', []);
cfg.circleSpacingXLeft = getParam(params, 'circleSpacingXLeft', []);
cfg.targetAvgSpacing = getParam(params, 'targetAvgSpacing', []);
cfg.minThroatRandom = getParam(params, 'minThroatRandom', []);
cfg.randomDensityFactor = getParam(params, 'randomDensityFactor', []);
cfg.useRandomParticleRadii = getParam(params, 'useRandomParticleRadii', []);
cfg.randomParticleRadiusMin = getParam(params, 'randomParticleRadiusMin', []);
cfg.randomParticleRadiusMax = getParam(params, 'randomParticleRadiusMax', []);
cfg.targetInitialPorosity = getParam(params, 'targetInitialPorosity', []);
