%> @file Transport/assembleSystem.m Assemble the linear system for the Transport problem.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%>
%> @sa HyPHM, Transport, Grid


%> @param   this       [ Transport ]  Data required by solver.
...
%       adjTidx = ones(3,1);  adjTidx = adjTidx + (g.sigE0T(kT, :) > 0)';    % column-index in g.T0E (ordering depds. on edge signs)
