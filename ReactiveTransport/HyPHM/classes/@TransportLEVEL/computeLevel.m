%> @file TransportLEVEL/computeLevel.m Compute the next time level for the unknowns @f$\vec{q}@f$ and @f$u@f$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%> @brief Compute the next time level for the unknowns @f$\vec{q}@f$ and @f$u@f$.
%>
%> @param this       [ TransportLEVEL ]  contains data required by solver
...
[Qnew, Unew, bigA, bigB] = ...
    solveSystem(this, curTau, B, C, D, E, bQ, bU, markNeumE, markFreeE, dataC, dataE, Y, isSlt, isVisPattern, markDirT);
